  ...
  return (
    ...
    <div className="w-1/2 bg-white flex items-center justify-center p-12">
      <div className="w-full max-w-md">
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-lg outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
        </div>
        ...
        {/* Login Button */}
        <button className="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors mb-6">
          Login Now
        </button>
    ...
    <div className="w-1/2 bg-linear-to-br from-orange-500 to-orange-700 flex items-center justify-center p-12 relative overflow-hidden">
      {/* Decorative circles */}
        ...
        <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-3xl p-12 mb-8">
          ...
          <div className="mt-8">
            <img
              ...
              className="mx-auto rounded-2xl w-64 h-80 object-cover"
            />
          </div>
        </div>
